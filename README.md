...
5. Add students to the organization. You can do in this two ways. The first is by manually adding students via email to the organization as members. This can be quite a pain if you have more than 5 students in your class. Luckily, once you send out (and they accept) the first assignment, they will be added to the organization as outside collaborators.
...
If you want these repositories to be private, you will have to take some additional steps. In step 4, we changed the default repository permission to "none". While this prevents students from viewing the homework assignments from other students, it unfortunately prevents them from viewing all other private repositories in the organization, such as your class information repository. We believe the least painful way for teachers to give access to students, especially when you have a large class, is to utilize organization teams. When you are in the viewing mode for the organization, click on the "Teams" panel. Click "New team" and name this team "students". After students have become organization members, direct them to the students team page, and have them click "Join". Then accept all these requests. Yes, this is a bit of a pain, but it's much better than manually typing in each student's username.

Finally, go into the private repository, then go to Settings -> Collaborators & teams. Then add the "students" team to have read access to this repo. Done!
